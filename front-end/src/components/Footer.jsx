            ...
            <div className="container">
                ...
                <div className="row mb-3">
                    ...
                    <div className="col-md-4 text-center text-md-start">
                        <h5>Contact Us</h5>
                        <p>Email: <a href="mailto:contact@jobportal.com" className="text-white">contact@jobportal.com</a></p>
                    ...
                    <div className="col-md-4 text-center">
                        <h5>Quick Links</h5>
                        <a href="#" className="text-white d-block">Privacy Policy</a>
                        <a href="#" className="text-white d-block">Terms of Service</a>
                        <a href="#" className="text-white d-block">Support</a>
                    </div>

                    {/* Social Icons */}
                    <div className="col-md-4 text-center">
                        <h5>Follow Us</h5>
                        <a href="#" className="text-white me-3 d-inline-flex align-items-center">
                        ...
                        <a href="#" className="text-white d-inline-flex align-items-center">
